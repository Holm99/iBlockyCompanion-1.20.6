...
5. **Add the Mod to Your Mods Folder**: Place the two downloaded mods (Fabric API and my mod) into your `C:\Users\yourusernamehere\AppData\Roaming\.minecraft\mods` folder. (If the mods folder do not exist just create it)
